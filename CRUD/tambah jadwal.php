...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    if(!isset($_POST["Waktu"]) || !isset($_POST["Tim1"]) || !isset($_POST["Tim2"]) || !isset($_POST["Kondisi"])){
        ...
        $sql = "INSERT INTO db_jadwal (Waktu, Tim1, Tim2, Kondisi) VALUES ('$Waktu', '$Tim1', '$Tim2', '$Kondisi')";

        if ($conn->query($sql) === TRUE) {
            $message = "<div class='message success'>Data jadwal berhasil ditambahkan!</div>";
        } else {
